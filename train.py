...
# system
device = 'cuda:${os.environ.get("LOCAL_RANK", 0)}' # examples: 'cpu', 'cuda', 'cuda:0', 'cuda:1' etc., or try 'mps' on macbooks
...
master_process = os.environ.get('RANK') is None or os.environ.get('RANK') == '0'
seed_offset = 0
ddp_world_size = 1
